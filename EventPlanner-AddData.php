  ...
  <div class="card card-authentication1 mx-auto my-4">
    <div class="card-body">
     <div class="card-content p-2">
      ...
      <div class="card-title text-uppercase text-center py-3">Add Employee's Data</div>
        <form>
        <div class="form-group">
        <label for="exampleInputName" class="sr-only">Name</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" class="form-control input-shadow" placeholder="Enter  Name">
        ...
        <div class="form-group">
        <label for="exampleInputEmailId" class="sr-only">Salary</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" class="form-control input-shadow" placeholder="Enter salary">
          <div class="form-control-position">
        ...
        <div class="form-group">
         <label for="exampleInputPassword" class="sr-only">Duty</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" class="form-control input-shadow" placeholder="Enter Duty">
          <div class="form-control-position">
            <i class="icon-user"></i>
          </div>
         </div>
        ...
        <div class="form-group">
         <label for="exampleInputPassword" class="sr-only"> Type</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" class="form-control input-shadow" placeholder="Enter Employee type">
          <div class="form-control-position">
            <i class="icon-user"></i>
          </div>
         </div>
        ...
        <div class="input-group">
                  ...
                  <br><br><br>
                  <input type="date"  id="birthday" name="birthday"  class="form-control input-shadow">

                 </div>
        
         
        
       <button type="button" class="btn btn-light btn-block waves-effect waves-light">ADD</button>
