   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="Admin-Customers.php">
          <i class="zmdi zmdi-accounts-outline"></i> <span>Customer</span>
        </a>
      </li>

      <li>
        <a href="Admin-EventPlanners.php">
          <i class="zmdi zmdi-accounts-outline"></i> <span>Event Planners</span>
        </a>
      </li>

      <li>
        <a href="Admin-Vendors.php">
          <i class="zmdi zmdi-accounts-outline"></i> <span>Vendors</span>
        </a>
      </li>
        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            ...
            <div class="card-body pt-5">
                ...
                <p class="card-text">I am a professional Vendor with 10 years of experience.</p>
        ...
        <div class="col-lg-8">
           <div class="card">
            ...
            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                ...
                <li class="nav-item">
                    <a href="javascript:void();" data-target="#edit" data-toggle="pill" class="nav-link"><i class="icon-note"></i> <span class="hidden-xs">View</span></a>
                </li>
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h6>HOBBIES</h6>
                            <p>
                                music, Selling, management and hiking. I love the great outdoors.
                            </p>
                       
                      <a href="admin-EP-seephotos.php"> <button class="b" style="font-size: 1rem; border: none;border-radius: 5px; background-color: #f7b731;color: white; ">See Photos</button></a>
      ...
      <div class="tab-pane" id="edit">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Rabia">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Last name</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Javed">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Email</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="email" value="rabia@example.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Vendor Type</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Manufactor">
                            </div>
                        </div>
                         <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="rabia2000">
                            </div>
                        </div>
