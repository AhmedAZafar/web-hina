...
<head>
  ...
  <title>Event planner-bookings</title>
  <!-- loader-->
...
<div class="content">
  <center>
     <div class="card-header" style="font-size: 2rem;">Accepted Bookings
       ...
       <input type="text" class="form-control mb-5" ng-model="allKeywords" placeholder="Search...." style="color: white; background-color: #222" />
