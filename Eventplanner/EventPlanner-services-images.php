...
<head>
  ...
  <title>Event planner-service-photos</title>
  <!-- loader-->
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <h1 class="heading">My<span>Photos</span></h1>
    ...
    cursor: pointer;
    overflow: hidden;">
            <img src="assets/images/g-9.jpg" alt="" style=" height: 100%;
    width: 100%;
    object-fit: cover;">
...
<div class="box" style=" position: relative;
    ...
    cursor: pointer;
    overflow: hidden;">
            <img src="assets/images/g-10.jpg" alt="" style=" height: 100%;
    width: 100%;
    object-fit: cover;">
            <h3 class="title" style=" position: absolute;
    top:-10rem; left:0; right: 0;
    ...
    cursor: pointer;
    overflow: hidden;">
            <img src="assets/images/g-11.jpg" alt="" style=" height: 100%;
    width: 100%;
    object-fit: cover;">
            <h3 class="title" style=" position: absolute;
    top:-10rem; left:0; right: 0;
    ...
    cursor: pointer;
    overflow: hidden;">
            <img src="assets/images/g-12.jpg" alt="" style=" height: 100%;
    width: 100%;
    object-fit: cover;">
            <h3 class="title" style=" position: absolute;
    top:-10rem; left:0; right: 0;
    ...
    cursor: pointer;
    overflow: hidden;">
            <img src="assets/images/g-13.jpg" alt="" style=" height: 100%;
    width: 100%;
    object-fit: cover;">
            <h3 class="title" style=" position: absolute;
    top:-10rem; left:0; right: 0;
