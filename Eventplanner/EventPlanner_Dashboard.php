  ...
  <!--Start Dashboard Content-->
        ...
        <div class="card">
           ...
           <div class="table-responsive">
             <table class="table align-items-center">
               <tbody>
                 <tr>
                   <td><i class="fa fa-circle text-white mr-2"></i> Upcoming Events</td>
                   <td>856</td>
                   <td>$453</td>
                 </tr>
                 <tr>
                   <td><i class="fa fa-circle text-light-1 mr-2"></i>Previous Events</td>
                   <td>2829</td>
                   <td>$4534</td>
                 </tr>
                 <tr>
                   <td><i class="fa fa-circle text-light-2 mr-2"></i>Best Events</td>
                   <td>2802</td>
                   <td>$4432</td>
                 </tr>
                 <tr>
	...
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header">Recent Bookings
                 ...
                 <table class="table align-items-center table-flush table-borderless">
                  <thead>
                   ...
                   <tbody>
                    ...
                    <td>Wedding</td>
					<td><a href="admin-add-product.php" class="button-add" style="margin: 2px;">Accept</a> <a href="admin-add-product.php" class="button-add">Reject</a></td>
                   </tr>
