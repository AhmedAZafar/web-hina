...
<head>
  ...
  <title>Signup as EventPlanenr</title>
  <!-- loader-->
...
<!-- Start wrapper-->
 <div id="wrapper">
	...
	<div class="card card-authentication1 mx-auto my-4" style="width: 1000px; height: 600px;">
		<div class="card-body" >
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="assets/images/logo-icon.png" alt="logo icon">
		 	</div>
		  <div class="card-title text-uppercase text-center py-3">Select Vendor Type</div>
...
<select name="cars" id="cars" class="form-control input-shadow">
 ...
 <a href="Vendor-Profile.php"> <button class="btn active" style="margin-top:350px; margin-left: 860px;" ><i class="fa fa-arrow-right"></i> NEXT</button></a>
</div>
