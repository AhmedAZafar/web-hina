...
<head>
  ...
  <title>Event planner-adddata</title>
  <!-- loader-->
  ...
  <div class="card card-authentication1 mx-auto my-4">
    <div class="card-body">
     <div class="card-content p-2">
      ...
      <div class="card-title text-uppercase text-center py-3">Update Employee's Data</div>
        <form>
        <div class="form-group">
        <label for="exampleInputName" >Name</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="exampleInputName" class="form-control input-shadow" value="Rabia Javed">
        ...
        <div class="form-group">
        <label for="exampleInputEmailId" >Salary</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="exampleInputEmailId" class="form-control input-shadow" value="55000">
          <div class="form-control-position">
        ...
        <div class="form-group">
         <label for="exampleInputPassword" >Duty</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="exampleInputPassword" class="form-control input-shadow" value="Managing ">
          <div class="form-control-position">
            <i class="icon-user"></i>
          </div>
         </div>
        ...
        <div class="form-group">
         <label for="exampleInputPassword" >Employee Type</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="exampleInputPassword" class="form-control input-shadow" value="Manager">
          <div class="form-control-position">
            <i class="icon-user"></i>
          </div>
         </div>
...
<div class="form-group">
         <label for="exampleInputPassword" >DOB</label>
         <div class="input-group">
                  
                  <br><br><br>
                  <input type="date"  id="birthday" name="birthday" value="2/3/2000" class="form-control input-shadow">
       ...
       <button type="button" class="btn btn-light btn-block waves-effect waves-light">Update</button>
