...
<head>
  ...
  <title>Admin-event planners</title>
  <!-- loader-->
...
<tbody class="eventplannerdata">
  ...
  <tr>
    ...
    <td>
      <?php
      if($rows['status']==1){
        echo'<p><a href="Eventplanner_status.php?id='.$rows['id'].'&status=0" class=delete>"Unblock"</a></p>';}
        else{
          echo '<p><a href="Eventplanner.status.php?id='.$rows['id'].'&status=1" class=delete>"Block"</a></p>';}?></a>
</td>
</tr>
</tbody>
<?php
...
<!-- 
  ...
  <img src="assets/images/pic-4.png" height="70" width="70" alt="Image of woman">
  <a href="Admin-EP-Profile.php"><p id="info" style="color: white"><b>Sundas</b> <br>023344</p></a>
  <div id="button-block">
...
<div id="fb" ; style="max-height: 100%;">
 ...
 <button onclick='scrollDown()' style="background-color: blue;"></button>
  ...
  <!--Start footer-->
  <footer class="footer" style="top: 250%; ">
      <div class="container">
