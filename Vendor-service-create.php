...
<head>
  ...
  <title>Vendor-Edit-Service</title>
  <!-- loader-->
  ...
  <div class="card card-authentication1 mx-auto my-4">
    <div class="card-body">
     <div class="card-content p-2">
      ...
      <div class="card-title text-uppercase text-center py-3">Create Service</div>
      <form action="service.create.action.php" method="POST" enctype='multipart/form-data'>
        <div class="form-group">
        <div class="form-group">
         <!-- <label for="exampleInputPassword" class="label">Id</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="id" class="form-control input-shadow" value="" readonly>
          
         </div>
        </div> -->
        <label for="exampleInputPassword" class="label">Service Name</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="servicename" class="form-control input-shadow" value="" required>
          
         </div>
        </div>
        <div class="form-group">
         <label for="exampleInputPassword" class="label">Category</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="category" class="form-control input-shadow" value="" required>
          
         </div>
        </div>
        <div class="form-group">
         <label for="exampleInputPassword" class="label">Company</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="company" class="form-control input-shadow" value="" required>
          
         </div>
        </div>
        <div class="form-group">
         <label for="exampleInputPassword" class="label">Price</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="price" class="form-control input-shadow" value="" required>
          
         </div>
        </div>
       
        <input type="submit" name="submit" value="Create Service" class="btn btn-light btn-block" >
