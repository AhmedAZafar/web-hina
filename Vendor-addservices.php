...
<head>
  ...
  <title>Vendor-ADDServices</title>
  <!-- loader-->
  ...
  <div class="card card-authentication1 mx-auto my-4">
    <div class="card-body">
     <div class="card-content p-2">
      ...
      <div class="card-title text-uppercase text-center py-3">ADD Service</div>


<form action="Vendor-addservices-action.php" method="POST" enctype="multipart/form-data">
...
<input type="file"  name="image" id="im" class="form-control input-shadow">
         ...
         <div class="position-relative has-icon-right">
          <input type="text" id="n" name="name" class="form-control input-shadow" placeholder="Enter service name " required="">
         ...
         <div class="position-relative has-icon-right">
          <input type="text" id="com"  name="company" class="form-control input-shadow" placeholder="Enter company name " required="">
         ...
         <div class="position-relative has-icon-right">
          <input type="text" id="cos" name="cost" class="form-control input-shadow" placeholder="Enter service Price " required="">
        ...
        <label for="av" >Availability</label>
         <div class="position-relative has-icon-right">
          <input type="date" id="av" name="availability" class="form-control input-shadow" required="">
...
<select id="ct" name="category" class="form-control input-shadow">
  ...
  <option value="Bakery: cakes and desserts">Bakery: cakes and desserts</option>
      ...
      <input type="submit" name="submit" value="upload" class="btn btn-light btn-block waves-effect waves-light">
