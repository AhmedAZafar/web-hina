...
{
?>
      <div class="card-title text-uppercase text-center py-3">Edit Service</div>
      <form action="service.edit.action.php" method="POST" enctype='multipart/form-data'>
        ...
        <label for="exampleInputPassword" class="label">Service Name</label>
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="servicename" class="form-control input-shadow" value="<?php echo $rows['name'];?>">
        ...
        <div class="form-group">
         ...
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="category" class="form-control input-shadow" value="<?php echo $rows['category'];?>">
        ...
        <div class="form-group">
         ...
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="company" class="form-control input-shadow" value="<?php echo $rows['company'];?>">
        ...
        <div class="form-group">
         ...
         <div class="position-relative has-icon-right">
          <input type="text" id="" name="price" class="form-control input-shadow" value="<?php echo $rows['price'];}?>">
          
         </div>
        </div>
       
        <input type="submit" name="submit" value="Edit Service" class="btn btn-light btn-block" >
