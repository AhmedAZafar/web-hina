...
<head>
  ...
  <title>Event planner-Staff</title>
  <!-- loader-->
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
   ...
   <div class="col-12 col-lg-12">
     ...
     <div class="content">
  <center>
       <div class="card-header" style="font-size: 2rem;">Team

       <a href="EventPlanner-AddData.php"> <button class="b" style="font-size: 1rem; border: none;border-radius: 5px; background-color: #f7b731;color: white; margin-left: 74%;">Add Employee's Data</button></a>
      ...
      <input type="text" class="form-control input-shadow" ng-model="allKeywords" placeholder="Search...."  />
         ...
         <div class="table-responsive">
                ...
                <td>{{search.dob}}</td>
                <td ng-bind="search.salary"></td>
                <td>{{search.position}}</td>
                <td ng-bind="search.duty"></td>
                <td><a href="Eventplanner-update-employee-data.php" class="button-add" style="margin: 2px;">Update</a> <a href="" class="button-add">Delete</a>
 ...
 <script>
    var search = [
            { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
             { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },

              { id: '8908', name: 'maya', dob : '8/6/1999' ,salary: '50000',position:'Assisstant',duty:'assisst' },

               { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
                { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
                 { id: '6889', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
                  { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
                   { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
                    { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
                     { id: '7393', name: 'waqar', dob : '2/3/2000' ,salary: '60000',position:'manager',duty:'managing' },
