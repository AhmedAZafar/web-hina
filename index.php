...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>Welcome <span><br> "Dream Plan Do" </span></h3>
        <a href="login.php" class="btn">Login</a>
        <a href="Signup.php" class="btn" button style="margin: 5px;">Signup </a>
...
<div class="row">
    ...
    <div class="content">
        ...
        <p><b>Dream Events</b> is an event logistics and marketing company which was formed back in 2018. The company offers A-Z event planning services from a team of experienced and energetic event planners, Vendors, venues and more. </p>
        <p>One of the main reasons behind the success of <b>Dream Events</b> is the fact that the team does not charge fees to its clients! With the number of events we organise, <b>Dream Events</b> does not need to add exorbitant fees and mark-ups to make its profit margins. This ensures that our clients list, which is constantly growing, make regular use of our services.</p>
    ...
    <div class="content">
        <h3>Our Belief.</h3>
        <p>In all these years, <b>Dream Events</b> has expanded its human and material resources to exquisitely manage a variety of events and cater every unique need that our client might be looking for. We specialize in weddings, BTL activities, promotional activities, team building activities, corporate events, weddings and catering services. Creativity is the first aspect of planning, we take into consideration, we do not bind imagination and ideas in a box and present it to every single client entering our doors.</p>
        <p> Our team focus remains on creating an exceptional event for clients who expect from us. Events planning strategies keep evolving at all levels, so that our corporate clients may get noticed effectively in the international markets.</p>
...
<section class="gallery" id="gallery">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="assets/images/g-13.jpg" alt="">
            <h3 class="title">photos and events</h3>
            <div class="icons">
                <a href="#" class="fas fa-heart"></a>
                <a href="#" class="fas fa-share"></a>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-map-marker-alt"></i> Peshawar </a>
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-envelope"></i> RabiaJaved@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> Hinanoor@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> Sundas@gmail.com </a>
    ...
    <div class="credit"> created by <span>Dream Event's Team</span> | all rights reserved </div>
...
.header{
    ...
    background-image: url(images/olaa.jpg);
