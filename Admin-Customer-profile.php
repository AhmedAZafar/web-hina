        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            ...
            <div class="card-body pt-5">
                ...
                <p class="card-text">Quality is my prioriy not quantity.</p>
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h6>ABOUT</h6>
                            <p>
                                The thing i prefer most is Quality.
                            </p>
                            <h6>HOBBIES</h6>
                            <p>
                                music,hiking. I love the great outdoors.
                            </p>
      ...
      <div class="tab-pane" id="edit">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Hina">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Last name</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Noor">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Email</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="email" value="Hina@example.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Hina2000">
                            </div>
                        </div>
